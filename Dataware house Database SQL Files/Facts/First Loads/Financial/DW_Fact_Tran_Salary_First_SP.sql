-----------------###### DW Fact Tran Salary First SP ######---------------
USE LibraryDW
GO
CREATE OR ALTER PROCEDURE DW_Fact_Tran_Salary_First_SP
AS
BEGIN
...
CREATE TABLE [LibraryDW].[dbo].[recent](
	...
	truncate table[LibraryDW].[FinancialDataMart].[FinancialTranFact_MaxDate]
	truncate table[LibraryDW].[FinancialDataMart].[transFactOverSalary];
...
--select * from [LibraryDW].[FinancialDataMart].[transFactOverSalary] 
--where  EmployeeID=20
