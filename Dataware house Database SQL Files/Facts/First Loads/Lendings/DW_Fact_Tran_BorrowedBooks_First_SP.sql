-----------------###### DW Fact Tran BorrowedBooks First SP ######---------------
USE LibraryDW
GO
CREATE OR ALTER PROCEDURE DW_Fact_Tran_BorrowedBooks_First_SP
AS
BEGIN
...
CREATE TABLE [LibraryDW].[dbo].[todayStock](
	...
	truncate table[LibraryDW].[LendingsDataMart].[LendingTranFact_MaxDate]
	truncate table[LibraryDW].[LendingsDataMart].[transactionFactOverBorrowedBooks];
	...
	BEGIN
			...
			insert into [LibraryDW].[dbo].[result] (BookID,BranchID,MemberID,EmployeeID,DateID,TimeKey,CategoryID,AgeRangeID,EditorID,LanguageID,TotalLendedCount,BookedCount,AvailableCount)
			select nd.BookID as BookID,nd.BranchID,nd.MemberID,nd.EmployeeID,nd.DateID,nd.TimeKey,nd.CategoryID,nd.AgeRangeID,nd.EditorID,nd.LanguageID,
			case 
			...
			insert into [LibraryDW].[LendingsDataMart].[transactionFactOverBorrowedBooks](BookID,BranchID,MemberID,EmployeeID,DateID,TimeKey,CategoryID,AgeRangeID,EditorID,LanguageID,TotalLendedCount,BookedCount,AvailableCount)
			select BookID,BranchID,MemberID,EmployeeID,DateID,TimeKey,CategoryID,AgeRangeID,EditorID,LanguageID,TotalLendedCount,BookedCount,AvailableCount
